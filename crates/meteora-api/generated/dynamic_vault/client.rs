...
impl HttpClient {
    ...
    pub fn with_config(enable_tracing: bool) -> Self {
        ...
        Self {
            base_url: "https://merv2-api.meteora.ag".to_string(),
            api_key: None,
            http_client,
...
impl HttpClient {
    ...
    pub async fn get_apy_state(
        &self,
        token_mint: impl AsRef<str>,
    ) -> Result<ApyState, ApiOpError<serde_json::Value>> {
        let request_url = format!(
            "{}{}",
            self.base_url,
            format!(
                "/apy_state/{}",
                __pct_encode_path_segment(token_mint.as_ref())
            )
        );
    ...
    pub async fn get_filter_apy_by_time_range(
        &self,
        token_mint: impl AsRef<str>,
        start_timestamp: impl AsRef<str>,
        end_timestamp: impl AsRef<str>,
    ) -> Result<ApyState, ApiOpError<serde_json::Value>> {
        let request_url = format!(
            "{}{}",
            self.base_url,
            format!(
                "/apy_filter/{}/{}/{}",
                __pct_encode_path_segment(token_mint.as_ref()),
                __pct_encode_path_segment(start_timestamp.as_ref()),
                __pct_encode_path_segment(end_timestamp.as_ref())
            )
        );
        let mut req = self.http_client.get(request_url);
        if let Some(api_key) = &self.api_key {
    ...
    ///
    /// `GET /vault_addresses`
    pub async fn get_vault_addresses(
        &self,
    ) -> Result<GetVaultAddressesResponse, ApiOpError<serde_json::Value>> {
        let request_url = format!("{}{}", self.base_url, "/vault_addresses");
        let mut req = self.http_client.get(request_url);
        if let Some(api_key) = &self.api_key {
            req = req.bearer_auth(api_key);
        }
    ...
    pub async fn get_vault_info(
        &self,
    ) -> Result<GetVaultInfoResponse, ApiOpError<serde_json::Value>> {
        let request_url = format!("{}{}", self.base_url, "/vault_info");
        let mut req = self.http_client.get(request_url);
        if let Some(api_key) = &self.api_key {
            req = req.bearer_auth(api_key);
        }
    ...
    pub async fn get_vault_state(
        &self,
        token_mint: impl AsRef<str>,
    ) -> Result<VaultState, ApiOpError<serde_json::Value>> {
        let request_url = format!(
            "{}{}",
            self.base_url,
            format!(
    ...
    ///
    /// `GET /virtual_price/{token_mint}/{strategy}`
    pub async fn get_virtual_price(
        &self,
        token_mint: impl AsRef<str>,
        strategy: impl AsRef<str>,
    ) -> Result<GetVirtualPriceResponse, ApiOpError<serde_json::Value>> {
        let request_url = format!(
            "{}{}",
            self.base_url,
            format!(
                "/virtual_price/{}/{}",
                __pct_encode_path_segment(token_mint.as_ref()),
                __pct_encode_path_segment(strategy.as_ref())
            )
        );
        let mut req = self.http_client.get(request_url);
        if let Some(api_key) = &self.api_key {
